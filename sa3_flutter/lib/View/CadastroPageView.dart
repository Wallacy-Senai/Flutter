...
class _PaginaCadastroState extends State<PaginaCadastro> {
  ...
  void cadastrarUsuario(BuildContext context) async {
    ...
    if (await bancoDados.existeUsuario(email)) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Este email já está em uso. Por favor, use outro.')),
      );
      return;
    }

    // Se o email não estiver em uso, cadastra o usuário
